...
class Encoder:
    ...
    def bpe(self, token: str) -> str:
        ...
        while pairs:
            ...
            if bigram not in self.bpe_ranks:
                break
            first, second = bigram
            # Left-to-right pass merging every adjacent (first, second) occurrence.
    ...
    def encode(self, text: str) -> list[int]:
        ...
        return self.encode_and_show_work(text)["bpe_idx"]
...
class BPETokenizer:
    ...
    def __call__(self, text: str, return_tensors: str = "pt") -> Tensor:
        ...
        # Shape: (1, num_tokens); the leading axis is a batch of one.
    ...
    def decode(self, idx: Tensor) -> str:
        ...
        Args:
            idx: Token IDs shaped ``(num_tokens,)``.
        ...
        """
        # idx: (num_tokens,) — pass ``tokens[0]`` when decoding a (1, num_tokens) batch.
        if idx.ndim != 1:
